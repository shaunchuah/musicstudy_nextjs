...
export default function Header() {
  return (
    <header>
      <div className="flex justify-between flex-wrap p-6 flex-col lg:flex-row items-center border-b-2">
        ...
        <nav className="flex flex-wrap items-center justify-center gap-4 md:gap-6 sm:text-xl">
          <Link href="/">
            <a className="flex flex-row items-center gap-1 hover:text-[#e76f51]">
              <svg
                className="w-5 h-5"
                fill="none"
                stroke="currentColor"
