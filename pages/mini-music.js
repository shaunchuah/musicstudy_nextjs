...
export default function MiniMUSIC() {
  return (
    <>
      <SEOHead
        title="Mini-MUSIC (Children)"
        description="The Mini-MUSIC study investigates inflammatory bowel disease in children and young people across Scotland's pediatric IBD centers."
      />
      <MotionPage>
        <main className="flex flex-col w-full">
          <SectionWrapperWhite id="introduction">
            ...
            <div className="text-xl space-y-4 max-w-prose">
              ...
              <p>
                The Mini-MUSIC study is the paediatric arm of the adult IBD
                MUSIC study making this research an all-ages IBD study.
              </p>
              <p>
                We hope that this study will unlock new scientific insights into
                what causes and drives gut inflammation in paediatric
                inflammatory bowel disease.
              </p>
              <p>
                During the year follow-up period, blood, stool and saliva
                samples are taken for scientific analyses. If you or your child
                are undergoing an endoscopy during the one-year study follow-up,
          ...
          <SectionWrapperWhite id="research">
            ...
            <div className="text-xl space-y-4 max-w-prose">
              ...
              <p>
                ...
                signals&apos; could be used as a test of disease activity in
                children and young people with IBD (Crohn&apos;s disease or
                ulcerative colitis or IBD-unclassified). We want to find out if
                DAMPs can tell us how your IBD is doing and if DAMPs can tell us
                more about how your bowel is compared to the current blood and
                stool tests available today.
              </p>
              <p>
                How do the bacteria in the mouth and the rest of your gut (your
                microbiome) change in Crohn&apos;s disease and ulcerative
                colitis and can these be used to predict disease activity?
              </p>
            </div>
          </SectionWrapperWhite>
          ...
          <SectionWrapperWhite id="takepart">
            ...
            <div className="text-xl space-y-4 max-w-prose">
              <ul className="list-disc list-outside pl-4 space-y-4">
                ...
                <li>
                  We will aim to organise research study appointments at the
                  same time as NHS appointments to minimise the impact on school
                  and work.
                </li>
                <li>
                  It may be a learning opportunity. Knowing more about the
                  condition and its treatment may help you or your child get
          ...
          <SectionWrapperWhite id="who">
            ...
            <div className="text-xl space-y-4 max-w-prose">
              ...
              <ul className="list-disc list-outside pl-4 space-y-4">
                ...
                <li>
                  Who have a diagnosis, or suspected diagnosis, of Crohn&apos;s
                  disease (CD) or ulcerative colitis (UC) or or IBD-unclassified
                  (IBDU)
                </li>
          ...
          <SectionWrapperWhite id="involvement">
            ...
            <div className="text-xl space-y-4 max-w-prose mb-12">
              <p>
                ...
                monitor your clinical progress alongside the scientific work
                which we will carry out. We will take 25ml extra blood (around 2
              ...
              <p>
                During the follow-up period, we will gather information on how
                you are doing, which will be shared with your treating NHS
                clinician.
              </p>
              <p>
                This may allow them to make treatment adjustments and check on
                how you&apos;re doing more closely than usual. For full details,
                please read the age-specific patient information sheet.
              </p>
            </div>
