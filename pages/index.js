            ...
            <div className="col-span-1">
                ...
                <div>
                  <div className="md:flex flex-row items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="mb-6">
                        Hear Molly share her journey as both patient and
                        research advocate.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-white text-gray-800 border p-4 md:p-6 rounded-lg shadow flex flex-wrap gap-4 justify-center lg:justify-start items-start mb-6">
                <div>
                  ...
                  <div>
                    <p className="mb-2">
                      This 3-minute summary covers our recent innovative
                      approach where patients analyzed and interpreted data from
          ...
          <div className="max-w-4xl mx-auto gap-4 lg:gap-6">
            ...
            >
              <div className="mb-4">
                ...
                <p className="mb-2">
                  ...
                  survey (3 minutes) to help us understand which test you prefer
                  if it performs similarly to current options. Your input will
              ...
              <details>
                ...
                <div className="mt-3 ml-4 pl-3 border-l-2 border-gray-300">
                  ...
                  <p className="mb-2">
                    ...
                    came out with the idea of a &apos;Patient-led&apos; effort.
                    We handed over the reins, 100% to our fab patient group.
                  </p>
                  ...
                  <p className="mb-2">
                    ...
                    With no input from analytical tools, clinicians, pharma
                    input, KOLs, researchers.
                  </p>
            ...
            >
              <p className="mb-2">
                ...
                . His experience and views help us shape the design and conduct
                of our research.
              </p>
              <p className="mb-4">
