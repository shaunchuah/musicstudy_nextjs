...
export default function Participants() {
  return (
    <>
      <SEOHead
        title="MUSIC (Adults)"
        description="The MUSIC study is a 12-month observational study investigating inflammatory bowel disease in adults across Edinburgh, Glasgow and Dundee, Scotland."
      />
      <MotionPage>
        <main className="flex flex-col w-full">
          ...
          <SectionWrapperWhite id="takepart">
            ...
            <div className="text-xl space-y-4 max-w-prose">
              <ul className="list-disc list-outside pl-4 space-y-4">
                ...
                <li>
                  It will be a learning opportunity for you. The more involved
                  you are with your treatment, the more you will learn about
                  your condition and how you can get back to full health as soon
                  as possible.
                </li>
                <li>
          ...
          <SectionWrapperWhite id="involvement">
            ...
            <div className="text-xl space-y-4 max-w-prose mb-12">
              <p>
                This is a 12-month follow-up study which will involve
                appointments at 3 monthly intervals. We plan to closely monitor
                your clinical progress in line with the scientific work which we
                will carry out.
              </p>
              <p>
              ...
              <p>
                ...
                please read the patient information sheet below.
              </p>
            </div>
